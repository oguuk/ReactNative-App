...
import { LogBox, StyleSheet, Text, View, Image, TouchableOpacity, ScrollView, Platform} from 'react-native';
        ...
        <View style={styles.cardContainer}>
            ...
            {Platform.OS === 'ios' ? (
                <AdMobBanner
                  ...
                  adUnitID="ca-app-pub-8988921918722380/2600831462"
                  style={styles.banner}
                />
            ) : (
                <AdMobBanner
                  bannerSize="fullBanner"
                  servePersonalizedAds={true}
                  adUnitID="ca-app-pub-8988921918722380/4276519993"
                  style={styles.banner}
                />
            )}
        </View>
